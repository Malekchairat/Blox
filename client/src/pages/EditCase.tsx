...
import { Heart, ArrowLeft, Moon, Sun, AlertCircle, Pencil } from "lucide-react";
...
export default function EditCase() {
  ...
  // Pre-populate form when case data loads
  useEffect(() => {
      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">
            {t("editCase.onlyAssociationsAdmins")}
          </p>
          <Button asChild>
  ...
  // Check ownership: association can only edit own cases
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 py-8">
        <div className="container max-w-3xl">
          <Card>
            <CardHeader>
              <CardTitle>{t("editCase.formTitle")}</CardTitle>
              <CardDescription>
                {t("editCase.formSubtitle")}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <Button type="submit" disabled={updateCaseMutation.isPending} className="flex-1">
                    {updateCaseMutation.isPending ? t("editCase.saving") : t("editCase.save")}
                  </Button>
                  <Button type="button" variant="outline" asChild>
                    <Link href={`/case/${caseId}`}>{t("common.cancel")}</Link>
                  </Button>
                </div>
              </form>
            </CardContent>
